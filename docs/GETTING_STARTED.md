...
```bash
mvn dependency:resolve -DgroupId=org.fireflyframework -DartifactId=fireflyframework-parent -Dversion=26.02.07 -Dpackaging=pom
```
...
```groovy
dependencies {
    implementation platform("org.fireflyframework:fireflyframework-bom:26.02.07")
...
<parent>
    <groupId>org.fireflyframework</groupId>
    <artifactId>fireflyframework-parent</artifactId>
    <version>26.02.07</version> <!-- new version -->
    <relativePath/>
</parent>
```
