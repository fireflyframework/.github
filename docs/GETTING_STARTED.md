...
```bash
mvn dependency:resolve -DgroupId=org.fireflyframework -DartifactId=fireflyframework-parent -Dversion=26.01.01 -Dpackaging=pom
```
...
```groovy
dependencies {
    implementation platform("org.fireflyframework:fireflyframework-bom:26.01.01")
